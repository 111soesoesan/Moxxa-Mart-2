...
import { getCustomerById, getCustomerActivity } from "@/actions/customers";
import { getShopOrders } from "@/actions/orders";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Mail, Phone, MapPin, Calendar, ShoppingCart } from "lucide-react";
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        // Load orders (would need customerId tracking in orders)
